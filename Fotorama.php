...
class Fotorama extends Widget
{
    ...
    /** @var bool Using of html data-params, if false - js object initialization */
    ...
    {
        if (!array_key_exists('id', $this->htmlOptions) && !isset($this->htmlOptions['id'])) {
            $this->htmlOptions['id'] = $this->id;
        }

        if ($this->useHtmlData) {
            if (array_key_exists('data', $this->clientOptions) && isset($this->clientOptions['data'])) {
                $this->items = ArrayHelper::remove($this->clientOptions, 'data', []);
            }
            if (array_key_exists('spinner', $this->clientOptions) && isset($this->clientOptions['spinner'])) {
    ...
    public function init()
    {
        ...
        $this->initOptions();
        Html::addCssClass($this->htmlOptions['class'], 'fotorama');
